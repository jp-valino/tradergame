    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="container py-4">
        ...
        <div className="card mb-4 overflow-hidden">
          <div className="flex">
            <button
              className={`flex-1 py-3 px-4 font-medium ${activeTab === 'portfolio' ? 'bg-accent text-white' : 'bg-secondary'}`}
              onClick={() => setActiveTab('portfolio')}
            >
              My Portfolio
            </button>
            <button
              className={`flex-1 py-3 px-4 font-medium ${activeTab === 'market' ? 'bg-accent text-white' : 'bg-secondary'}`}
