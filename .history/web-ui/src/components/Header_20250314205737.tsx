          ...
          <div className="flex justify-between items-center">
            ...
            <div className="flex gap-2">
              ...
              <div className="md:hidden">
                <button className={`btn btn-secondary ${isScrolled ? 'btn-icon' : 'p-2'}`} onClick={() => {
                  ...
                  <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M4.75 5.75H19.25M4.75 12H19.25M4.75 18.25H19.25" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                  </svg>
                </button>
              </div>
            </div>
